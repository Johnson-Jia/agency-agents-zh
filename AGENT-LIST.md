...
> 本文档自动生成于 2026-03-21，记录项目中所有 186 个 AI 智能体的完整信息。
...
| `marketing-ai-citation-strategist` | AI 引用策略师 | AI 推荐引擎优化（AEO/GEO）专家，审计品牌在 ChatGPT、Claude、Gemini、Perplexity 等平台的可见性 | 翻译 |
| `marketing-bilibili-content-strategist` | B站内容运营专家 | B站内容运营专家，专注 UP主成长、弹幕文化运营、B站算法优化、社区建设和品牌内容策略 | 翻译 |
...
| `specialized-french-consulting-market` | 法国自由职业市场导航专家 | 法国 ESN/SI 自由职业生态导航专家，精通利润模型、平台机制、薪资代管、费率定位和付款周期 | 翻译 |
| `specialized-korean-business-navigator` | 韩国商务文化导航专家 | 韩国商务文化导航专家，精通품의决策流程、눈치社交智慧、KakaoTalk 商务礼仪、层级关系处理 | 翻译 |
| `recruitment-specialist` | 招聘运营专家 | 招聘运营与人才获取专家，精通国内主流招聘平台、人才评估体系和劳动法合规 | ⭐ 原创 |
| `supply-chain-strategist` | 供应链策略师 | 供应链管理与采购策略专家，精通供应商开发、战略寻源、质量管控和供应链数字化 | ⭐ 原创 |
...
| 部门 | 数量 | 占比 |
|------|------|------|
| 🔬 专项部 (Specialized) | 33 | 17.7% |
| 📢 营销部 (Marketing) | 35 | 18.8% |
| 🛠️ 工程部 (Engineering) | 27 | 14.5% |
| 🎮 游戏开发部 (Game Development) | 20 | 10.8% |
| 🧪 测试部 (Testing) | 9 | 4.8% |
| 🎨 设计部 (Design) | 8 | 4.3% |
| 🤝 支持部 (Support) | 8 | 4.3% |
| 💼 销售部 (Sales) | 8 | 4.3% |
| 📋 项目管理部 (Project Management) | 6 | 3.2% |
| 🥽 空间计算部 (Spatial Computing) | 6 | 3.2% |
| 📖 学术部 (Academic) | 6 | 3.2% |
| 💰 付费媒体部 (Paid Media) | 7 | 3.8% |
| 📦 产品部 (Product) | 5 | 2.7% |
